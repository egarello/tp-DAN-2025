...
INSERT INTO tp_dan.tarifa (fecha_inicio, fecha_fin, id_tipo_habitacion, precio_noche) VALUES
    ('2024-03-01', '2024-05-31', 1, 120.00), -- Single
    ('2024-03-01', '2024-05-31', 2, 160.00), -- Doble Individual
    ('2024-03-01', '2024-05-31', 3, 180.00), -- Doble
    ('2024-03-01', '2024-05-31', 4, 220.00), -- Triple Individual
    ('2024-03-01', '2024-05-31', 5, 240.00), -- Triple
    ('2024-03-01', '2024-05-31', 6, 280.00), -- Cuádruple
    ('2024-03-01', '2024-05-31', 7, 200.00), -- Doble Superior
    ('2024-03-01', '2024-05-31', 8, 260.00), -- Triple Superior
    ('2024-03-01', '2024-05-31', 9, 300.00), -- Cuádruple Superior
    ('2024-09-01', '2024-11-30', 1, 120.00), -- Single
    ('2024-09-01', '2024-11-30', 2, 160.00), -- Doble Individual
    ('2024-09-01', '2024-11-30', 3, 180.00), -- Doble
    ('2024-09-01', '2024-11-30', 4, 220.00), -- Triple Individual
    ('2024-09-01', '2024-11-30', 5, 240.00), -- Triple
    ('2024-09-01', '2024-11-30', 6, 280.00), -- Cuádruple
    ('2024-09-01', '2024-11-30', 7, 200.00), -- Doble Superior
    ('2024-09-01', '2024-11-30', 8, 260.00), -- Triple Superior
    ('2024-09-01', '2024-11-30', 9, 300.00)  -- Cuádruple Superior
ON CONFLICT (id) DO NOTHING;

-- Tarifas para temporada baja (junio - agosto)
INSERT INTO tp_dan.tarifa (fecha_inicio, fecha_fin, id_tipo_habitacion, precio_noche) VALUES
    ('2024-06-01', '2024-08-31', 1, 100.00), -- Single
    ('2024-06-01', '2024-08-31', 2, 130.00), -- Doble Individual
    ('2024-06-01', '2024-08-31', 3, 150.00), -- Doble
    ('2024-06-01', '2024-08-31', 4, 180.00), -- Triple Individual
    ('2024-06-01', '2024-08-31', 5, 200.00), -- Triple
    ('2024-06-01', '2024-08-31', 6, 230.00), -- Cuádruple
    ('2024-06-01', '2024-08-31', 7, 170.00), -- Doble Superior
    ('2024-06-01', '2024-08-31', 8, 220.00), -- Triple Superior
    ('2024-06-01', '2024-08-31', 9, 250.00)  -- Cuádruple Superior
ON CONFLICT (id) DO NOTHING;
